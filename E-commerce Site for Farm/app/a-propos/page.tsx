    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="space-y-8">
        ...
        <div className="prose prose-stone prose-lg max-w-none">
          <p>Bienvenue à la Ferme des Hirondelles, située au cœur de Kraainem. Nous sommes une exploitation familiale passionnée par l'agriculture durable et le respect de la nature.</p>
          <h3>Notre Histoire</h3>
          <p>Depuis plusieurs générations, nous cultivons la terre avec amour. Ce qui a commencé comme une petite exploitation est devenu un lieu de rencontre pour tous les amateurs de produits frais et locaux.</p>
          <h3>Nos Valeurs</h3>
          <ul>
          ...
          <p>Pour garantir une fraîcheur absolue et éviter le gaspillage, nous fonctionnons uniquement sur commande. Cela nous permet de récolter et de préparer vos colis juste avant votre venue.</p>
        </div>
      </div>
    </div>
  )
