    ...
    <footer className="bg-stone-900 text-stone-300 py-12">
      <div className="container mx-auto px-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1 text-sm">
                ...
                <p className="text-orange-300">
                  Commandes ouvertes jusqu'au Jeudi 23h59
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-stone-500">
          <p>&copy; {newjwDate().getFullYear()} Ferme des Hirondelles. Tous droits réservés.</p>
          <div className="flex gap-4 mt-4 md:mt-0">
            <span className="hover:text-stone-300 cursor-pointer">Mentions Légales</span>
            <Link to="/cgv" className="hover:text-stone-300 cursor-pointer">CGV</Link>
...
// Helper for date to avoid issues if needed, though standard Date is fine.
const newjwDate = () => new Date();
