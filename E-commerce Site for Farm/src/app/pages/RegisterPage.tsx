      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Rejoignez la Ferme des Hirondelles pour commander vos produits frais
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-start space-x-3 pt-4 border-t">
              ...
              <div className="space-y-1">
                ...
                >
                  J'accepte les <Link to="/cgv" target="_blank" className="text-green-600 font-medium hover:underline">Conditions Générales de Vente</Link> et la <Link to="/confidentialite" className="text-green-600 font-medium hover:underline">Politique de Confidentialité</Link>.
                </Label>
        ...
        <CardFooter className="flex justify-center text-sm text-stone-500">
          <div>
            Déjà un compte ?{' '}
            <Link to="/connexion" className="text-green-600 font-medium hover:underline">
              Se connecter
            </Link>
          </div>
        </CardFooter>
