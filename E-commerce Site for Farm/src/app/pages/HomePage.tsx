            ...
            },
            {
              ...
              desc: (
                <span>
                  ...
                  >
                    📍 33 rue du Moulin, 1950 Crainhem
                  </a>
                </span>
              )
            }
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 space-y-6">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-stone-900 mt-1">
                Authenticité & Circuit Court
              </h2>
            </div>
            
            <div className="space-y-4 text-lg text-stone-700">
              <p>
                À la Ferme des Hirondelles, nous croyons en une agriculture raisonnée, locale et respectueuse.
                Nos bêtes sont élevées avec soin et nos légumes poussent au rythme des saisons, dans le respect de la nature et du vivant.
              </p>
              <p>
                Nous avons fait le choix du circuit court, afin de limiter au maximum les intermédiaires.
                Cela nous permet de proposer des prix justes, qui reflètent une relation directe entre le producteur et le consommateur.
              </p>
            ...
            <div className="pt-2">
              <h3 className="text-xl font-bold text-stone-900 mb-4">Nos engagements</h3>
              <ul className="space-y-3">
                {[
                  "Viande issue d’élevages respectueux, avec une attention particulière portée au bien-être animal",
                  "Légumes de saison, cultivés sans recours aux pesticides intensifs",
                  "Production locale, en circuit court",
                  "Transparence totale sur l’origine et la méthode de production",
                  "Prix justes, pensés pour rémunérer correctement le producteur"
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-3 font-medium text-stone-800">
            ...
            <div className="pt-6">
              <Link to="/boutique">
                <Button size="lg" variant="default" className="bg-stone-900 text-white hover:bg-stone-800">
                  Voir nos produits
                </Button>
              </Link>
            </div>
